...
contract Accounts is CloneFactory, Test {
    ...
    function openPosition(
        ...
        console.log("universalTransferFrom");
        ...
        console.log("universalApprove");

        console.log("router openPosition b");

        position.account = address(this);

        router.openPosition{value: msg.value}(position, isShort, _tokens, _amts, route, _data, _customData);
        console.log("router openPosition a");
    }
    ...
    function closePosition(
        ...
        console.log("closePosition sender", msg.sender);
        IPositionRouter router = routers[msg.sender];
        console.log("closePosition router", address(router));
    ...
    function getOrCreateRouter(address _user) internal returns (IPositionRouter) {
