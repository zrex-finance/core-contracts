...
contract Connectors {
     ...
     */
    function addConnectors(string[] calldata _names, address[] calldata _connectors) external onlyConfigurator {
     ...
     * @param _connectors Array of Connector Address.
     */
    function updateConnectors(string[] calldata _names, address[] calldata _connectors) external onlyConfigurator {
        require(_names.length == _connectors.length, Errors.INVALID_CONNECTORS_LENGTH);
     ...
     * @param _names Array of Connector Names.
     */
    function removeConnectors(string[] calldata _names) external onlyConfigurator {
