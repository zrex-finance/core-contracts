...
contract PositionAaveV3Polygon is UniversalPosition, DeployPolygonContracts {
    ...
    function _getDepositCallData(address _collateral) public view override returns (bytes memory) {
        return abi.encodeWithSelector(aaveV3Connector.deposit.selector, _collateral);
    }

    function _getBorrowCallData(address _debt) public view override returns (bytes memory) {
        return abi.encodeWithSelector(aaveV3Connector.borrow.selector, _debt, RATE_TYPE);
    }

    function _getPaybackCallData(address _debt, uint256 _borrowAmount) public view override returns (bytes memory) {
        return abi.encodeWithSelector(aaveV3Connector.payback.selector, _debt, _borrowAmount, RATE_TYPE);
    }
    ...
    function _getWithdrawCallData(
        ...
        return abi.encodeWithSelector(aaveV3Connector.withdraw.selector, _collateral, _collateralAmount);
    }
