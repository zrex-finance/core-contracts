...
/**
 * @title FlashResolver contract
 * @author FlashFlow
 * @notice Deprecated contract moving to JS
 */
contract FlashResolver {
    ...
    IFlashAggregator internal flashloanAggregator;

    constructor(IFlashAggregator _flashloanAggregatorAddr) {
        flashloanAggregator = _flashloanAggregatorAddr;
    }
